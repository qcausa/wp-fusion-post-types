...
function wpf_render_postType_field_select( $setting, $meta_name, $field_id = false, $field_sub_id = false ) {
	//BugFu::log("wpf_render_postType_field_select init");
	//BugFu::log($post_type);
	...
	$crm_fields = wpf_get_option( $post_type . '_fields' );
